...
urlpatterns = [
    ...
    path('export-students-docx/', views.export_students_docx, name='export_students_docx'),  # New URL for DOCX export
    path('add-quiz/', views.add_quiz, name='add_quiz'),
    path('generate-quiz-description/', views.generate_quiz_description, name='generate_quiz_description'),
    ...
    path('delete-quiz-attempt/<int:attempt_id>/', views.delete_quiz_attempt, name='delete_quiz_attempt'),
